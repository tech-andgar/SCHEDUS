...
<nav class="navbar sticky-top navbar-expand-lg navbar-light" style="background-color:#EC7C38;">
    ...
    <div class="collapse navbar-collapse col-12 col-md-10" id="navbarSupportedContent">
        ...
        <li>
            <a class="btn btn-outline-light my-2 mr-3  my-sm-0" href="#" data-toggle="modal" data-target="#Perfil">Lder</a>
        </li>
        <li>
            <a class="btn btn-outline-light my-2 my-sm-0" href="" >Cerrar sesion</a>
        </li>
        </ul>
    </div>
    </div>
            ...
            <div class="row">
			    <div class="col-md-12">
                    <center>                     
                        ...
                        <table>
                        <tr>
                            <td><h5>Numero de Documento</h5></td>
                        ...
                        <tr>
                            ...
                            <td><input type="password" class="adsi-css"  name="password" placeholder="Contraseña" required/></td>
                        </tr> 
                        </table>
                        <div class="modal-body">
