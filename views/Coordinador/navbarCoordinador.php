        ...
        <div class="container">
            ...
            <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="btn btn-outline-light my-2 my-sm-0" href="index.php?c=Coordinador&m=Aprobar">Aprobar</a>
                    </li>
                    <li class="nav-item active">
                        <a class="btn btn-outline-light my-2 my-sm-0" href="index.php?c=Coordinador&m=Horas_Instructores">Horas Instructores</a>
                    </li>
                </ul>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="modal-body">
                        ...
                        <center>
                            <h3 class="modal-title" id="Perfil">Perfil</h3>
                        </center>
                    </div>
                </div>
                <div class="modal-body">
                                ...
                                <form method="POST" action="../controlador/validar.php" class="form-signin">
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="adsi-css" name="text" placeholder="Nombre"
                                                    required /></td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td><input type="email" class="adsi-css" name="email" placeholder="Correo"
                                                    required /></td>
                                        </tr>
                                        <tr>
                                            <td>
