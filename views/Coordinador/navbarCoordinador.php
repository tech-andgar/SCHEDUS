    ...
    <div class="collapse navbar-collapse col-12 col-md-10" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item active">
          <a class="btn btn-outline-light mx-2 my-2 my-sm-0" href="index.php?c=Coordinador&m=Aprobar">Aprobar</a>
        </li>
        <li class="nav-item active">
          <a class="btn btn-outline-light mx-2 my-2 my-sm-0" href="index.php?c=Coordinador&m=Horas_Instructores">Horas
            Instructores</a>
        </li>
      </ul>
