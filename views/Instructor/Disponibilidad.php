...
<div class="col-lg-12 col-md-8 col-12">
	<div class="row justify-content-center text-center  ">
		<div class="col-md-12">
			...
			<br>
			<h2 class="mb-1">Disponibilidad Horaria</h2>
			<hr>
		</div>
		<div class="container">
		...
		<h3 class=" ">PROGRAMA DE FORMACIÓN: Tecnologo en análisis y desarrollo de sistemas de información
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="modal-body">
					...
					<h3 class="modal-title text-center" id="exampleModalLongTitle">Agregar Titulo</h3>
				</div>
			</div>
			<div class="modal-body">
